...
if(isset($_SESSION['Email'])) {
    ...
    $sqlq = "SELECT UserName, Email, Address FROM admin WHERE Email = '$user_id'";
  ...
  <a href="update1hari.php"  target="_blank" class="B1">Update</a>
        ...
        <div class="footer">
            ...
            <div style = "height:250px; width: 600px; float:left; align-content: center;">
                <a  href = "home.html"><img class="ing" src = "./kisspng-health-care-public-health-medicine-hospital-cupped-hands-5b5bed5c876c37.1058234415327511965547.png"  ></a>
