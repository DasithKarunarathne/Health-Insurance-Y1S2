...
<body>
    <div class="lok">
        ...
        <div class="regis">
            <h1>Sign up</h1>
            <form class="from" method="post" action="insert.php">
                <div class="setall">
                    <div class="name">
                        <div class="frist">
       ...
       required>
                    ...
                    <div class="repass">
                        ...
                        <input type="password" id="re-passw" name="re_passw" placeholder="Re-enter your password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" 
       title="Password must contain at least one number, one uppercase and lowercase letter, and be at least 8 characters long" 
       required>    >
                    </div>
                    <div class="button">
                    ...
                    <div class="pnp">
                        <label>Stff member<label>
                        <a href="admregister.php">admin register<a><div>
                </div>
